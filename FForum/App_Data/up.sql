...
(
    ...
    CONSTRAINT [FK_dbo.Forum_dbo.AspNetUsers_UserID] FOREIGN KEY ([UserID]) REFERENCES [dbo].[AspNetUsers] ([Id]) on DELETE CASCADE,
    CONSTRAINT [FK_dbo.Forum_dbo.Category_CategoryID] FOREIGN KEY ([CategoryID]) REFERENCES [dbo].[Category] ([ID]) on DELETE CASCADE
);
